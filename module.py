...
def discriminator(wave, options, reuse=False, name="discriminator"):
    ...
    with tf.variable_scope(name):
        ...
        c1 = lrelu(instance_norm_1d(conv1d(wave, output_dim=options.conv_dim,
                                           input_c=wave_dim[2], ks=8, s=2, name='d_c1_conv1d'), name='d_c1_inorm'))
...
def generator(wave, options, reuse=False, name="generator"):
    ...
    with tf.variable_scope(name):
        ...
        c1 = instance_norm_1d(conv1d(wave, output_dim=options.conv_dim,
                                     input_c=wave_dim[2], ks=8, s=2, name='g_c1_conv1d'), name='g_c1_inorm')
        c1_dim = c1.get_shape().as_list()
        ...
        d1 = deconv1d(c9, output_shape=[tf.shape(c9)[0], (int)(c9_dim[1] * 2),
